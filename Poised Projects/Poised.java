	...
	public class Poised {
		...
		public static void main (String [] args){				//Main method declaration
			 ...
			 */
			try {
				File file = new File("C:\\Users\\deanf\\Dropbox\\Dean Featherstone-56191\\Introduction to Software Engineering\\Task 24\\Poised.txt");
				Scanner projFile = new Scanner(file);
				
				while (projFile.hasNextLine()) {						//add project objects to list obtained from text file
